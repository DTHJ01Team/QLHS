 ...
 * @author User
 */
public class K10 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(K10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
